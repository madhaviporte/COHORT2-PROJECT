...
const Login = () => {
let { register, handleSubmit, onLoginSubmit, errors, isValid } = useAuth();
    ...
    <div className="flex min-h-screen bg-[#09090b] text-white selection:bg-violet-500/30">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-black items-end p-12">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-lineart-to-t from-[#09090b] via-[#09090b]/50 to-transparent"></div>
        </div>
        <div className="relative z-10 w-full max-w-lg mb-8">
          ...
          <p className="text-gray-300 text-lg mb-10 leading-relaxed font-light">
            Continue where you left off. Reconnect your world to the beauty of seamless design and raw intelligence.
          </p>
          <div className="flex gap-12">
            <div>
              <div className="text-2xl font-bold text-white mb-1">99.9%</div>
              <div className="text-sm text-gray-400 font-medium tracking-wide">Secure</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-white mb-1">Fast</div>
              <div className="text-sm text-gray-400 font-medium tracking-wide">Sync enabled</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16 relative overflow-hidden">
        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-white mb-2">Sign in to your workspace</h2>
          ...
          <form onSubmit={handleSubmit(onLoginSubmit)} className="space-y-5">
            ...
            <div className="flex items-start pt-2">
              ...
              <label htmlFor="staySigned" className="ml-3 text-sm text-gray-400 font-medium">
                Stay signed in
              </label>
            </div>
