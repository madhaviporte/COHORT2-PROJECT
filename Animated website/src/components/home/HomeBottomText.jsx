...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-2 '>
      <p className='absolute lg:w-[10vw] w-64 lg:right-20 right-2 bottom-25  lg:bottom-35 font-[font1] lg:text-lg text-xs lg:leading-relaxed leading-tight'>
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-40 flex items-center px-2 pt-1 lg:px-10 border-white rounded-full uppercase'>
